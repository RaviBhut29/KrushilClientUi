          ...
          >
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  Welcome to Flyses (“Company”, “we”, “our”, “us”)! <br />
                  These Terms of Service (“Terms”, “Terms of Service”) govern
                  your use of our website located at flyses.com (together or
                  individually “Service”) operated by Flyses.
                  <br />
                  ...
                  emailing at contact@flyses.com so we can try to find a
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  link or by emailing at contact@flyses.com.
                </p>
              </div>
            </div>
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  certain information relevant to your Purchase including but
                  not limited to, your credit or debit card number, the
                  expiration date of your card, your billing address, and your
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  will be set depending on the type of subscription plan you
                  select when purchasing a Subscription.
                  <br />
                  At the end of each Billing Cycle, your Subscription will
                  automatically renew under the exact same conditions unless you
                  cancel it or Flyses cancels it. You may cancel your
                  Subscription renewal either through your online account
                  management page or by contacting contact@flyses.com customer
                  support team.
                  <br />
                  A valid payment method is required to process the payment for
                  your subscription. You shall provide Flyses with accurate and
                  complete billing information that may include but not limited
                  to full name, address, state, postal or zip code, telephone
                  number, and a valid payment method information. By submitting
                  such payment information, you automatically authorize Flyses
                  to charge all Subscription fees incurred through your account
                  to any such payment instruments.
                  <br />
                  Should automatic billing fail to occur for any reason, Flyses
            ...
            <div className="form-row First">
              ...
              >
                <h4>6. Free Trial</h4>
                <p className="termsDesc">
                  Flyses may, at its sole discretion, offer a Subscription with
                  ...
                  Free Trial, you will not be charged by Flyses until Free Trial
                  ...
                  you have selected.
                  <br />
                  At any time and without notice, Flyses reserves the right to
            ...
            <div className="form-row First">
              ...
              >
                <h4>8. Refunds</h4>
                <p className="termsDesc">
                  We issue refunds for Contracts within 7 days of the original
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  <br />
                  Flyses has the right but not the obligation to monitor and
                  edit all Content provided by users.
                  <br />
                  In addition, Content found on or through this Service are the
                  property of Flyses or used with permission. You may not
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  exclusive property of Flyses and its licensors. Service is
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  your claim via email to contact@flyses.com, with the subject
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  You may provide us either directly at contact@flyses.com or
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  services that are not owned or controlled by Flyses.
                  <br />
                  Flyses has no control over, and assumes no responsibility for
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  the laws of USA, Europe, which governing law applies to
            ...
            <div className="form-row First">
              ...
              >
                ...
                <p className="termsDesc">
                  ...
                  support by email: contact@flyses.com.
                </p>
              </div>
            </div>
          </div>
